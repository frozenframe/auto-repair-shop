...
namespace AutoRepairShop
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            DbCarBrand dbCarBrand = new DbCarBrand();
            CarBrands carBrands = new CarBrands(dbCarBrand.getCarBrands());
            ...
            DbCarModel dbCarModel = new DbCarModel();
            List<CarModel> carModels = dbCarModel.getCarModels(newCarBrand);
